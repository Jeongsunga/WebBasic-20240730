...
/*
    ...
    - javascript의 생성자는 오버로딩이 안 됨
*/
class King {
    // constructor () {}  -> 생성자는 한 번만 작성 가능
...
class Sample1 {
    ...
    // static private 필드
    static #staticPrivateField = '정적 프라이빗 필드';  // 생성자 불가능
...
// sample3instance.staticMethod();  -> static 메서드는 인스턴스 불가
