...
/*
    - + 단항 연산자는 숫자 타입이 아닌 피연산자에 사용하여 숫자 타입으로 변환시킬 수 있음
*/
console.log(typeof +10);  // number
console.log(typeof +'10');  // number
console.log(typeof +'십');  // number(NaN)
console.log(+false);  // 0
...
/*
    ...
    - !== 불일치 비교
*/
// 동등, 부등 비교는 자동 형변환을 수행 후 연산 진행 (데이터 타입 영향을 받지 않음)
console.log(10 == '10');
// 일치, 불일치 비교는 형변환을 수행하지 않음 (데이터 타입 영향을 받음)
console.log(10 === '10');
