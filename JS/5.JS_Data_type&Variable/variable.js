...
var varVariable = 10;
let letVariable = 10;
const constVariable = 10;  // 상수형 변수

/*
    변수의 중복 선언 : var 키워드를 사용한 변수 선언 시 가능
*/
var age = 20;
var age = 30;

// let 키워드로 선언한 변수는 중복 선언 불가능
let address = '부산시';
// let address = '서울시';
...
/*
    ...
    - 블록 레벨 스코프 : 코드 블록 내에서 선언된 변수는 코드 블록 내에서 사용 가능, 코드 블록 밖에선 사용 불가능
*/
z = 10;
console.log(z);
...
/*
    ...
    - 이런 문제를 해결하기 위해 ES6+에서는 var 사용을 지양하고 let, const 키워드 사용을 권장
*/
console.log(y)
let y = 99;
if(true) {
