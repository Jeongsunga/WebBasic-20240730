...
/*
    ...
    - private : 클래스 내부
    - TypeScript는 패키지라는 개념이 없기 때문에 기본 값은 public으로 지정
*/
class Sample2 {
...
class Sample3 {
    ...
    constructor(
        ...
        protected protectedField: string,
        private privateField: string,
        localVariable: string // 매개변수 (아무런 속성을 가지고 있지 않음)
    ) {}
...
const sample4Instance = new Sample4('읽기 전용2', '읽기 전용3');
